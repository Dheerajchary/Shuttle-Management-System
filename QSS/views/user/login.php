...
if (isset($_POST['submit'])) {
    ...
    $stmt = mysqli_prepare($connection, "SELECT password, role FROM `users` WHERE username = ?");
      ...
      <div class="col-12 col-sm-10 col-md-6 col-lg-5 col-xl-4">
        <div class="card border border-light-subtle rounded-3 shadow-sm">
          <div class="card-body p-4">
            <h2 class="fs-6 fw-normal text-center text-secondary mb-4">Enter Credentials</h2>
            <?php if ($error): ?>
            ...
            <form action="" method="post">
              ...
              <div class="d-grid gap-2">
                ...
                <a href="/views/user/signup.php" class="btn btn-outline-secondary">Sign Up</a>
              </div>
            </form>
          </div>
        </div>
